        ...
        plugins: [
          {
            ...
            options: {
              target: '_blank', // Ensures external links open in a new tab
              rel: 'nofollow noopener noreferrer', // Improves security for external links
            },
          },
          {
            ...
            options: {
              maxWidth: 700, // Maximum width for images
              linkImagesToOriginal: true, // Links images to their original size
              quality: 90, // Image quality
              tracedSVG: { color: config.colors.green }, // Optional traced SVG placeholder with green color
            },
          },
          {
          ...
          }, // IMPORTANT: this must be ahead of other plugins that use code blocks
          {
            ...
            options: {
              ...
              // A suggested value for English speakers is the non-ascii character '›'.
